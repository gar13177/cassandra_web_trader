...
<head>
    ...
    <link href="/css/adx.css" rel="stylesheet">
      ...
      <nav class="navbar navbar-default">
        <div class="container-fluid">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="/home">Cassandra Web Trader</a>
          </div>
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="dropdown">
                ...
                <ul class="dropdown-menu">
                  <li><a href="/member/chart/ichimoku">Ichimoku Cloud</a></li>
                  <li><a href="/member/chart/adx"">Average Directional Index</a></li>
                </ul>
              <li><a href="/admin/watchlist">Watchlist</a></li>li>
              <li class="dropdown">
